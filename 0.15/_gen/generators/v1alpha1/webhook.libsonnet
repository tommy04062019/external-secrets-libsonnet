{
  ...
  '#spec':: d.obj(help='"WebhookSpec controls the behavior of the external generator. Any body parameters should be passed to the server through the parameters field."'),
  spec: {
    ...
    result: {
      ...
      withJsonPath(jsonPath): { spec+: { result+: { jsonPath: jsonPath } } },
    },
